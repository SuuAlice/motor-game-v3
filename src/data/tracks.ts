...
const RAW_TRACKS: TrackDefinition[] = [
  {
    ...
    objectives: [finish('straight-finish'), targetTime('straight-time', 3.66)],
  ...
  },
  {
    ...
    segments: [
      ...
      { lengthM: 6, slopeDeg: 40, surfaceGrip: 0.9, roughness: 0.05 },
      { lengthM: 2, slopeDeg: 0, surfaceGrip: 0.95, roughness: 0 },
    ],
    allowReverse: true,
    objectives: [finish('hill-finish'), targetTime('hill-time', 6.9)],
    exObjectives: [finish('hill-ex-finish'), targetTime('hill-ex-time', 6.9), maxEnergy('hill-ex-energy', 55.9)],
  },
  {
    id: 'curve-balance',
    name: '机上カーブ',
    ...
    objectives: [finish('curve-finish'), targetTime('curve-time', 13.02)],
  ...
  },
  {
    ...
    objectives: [finish('rough-finish'), targetTime('rough-time', 3.69)],
  ...
  },
  {
    ...
    objectives: [finish('energy-finish'), maxEnergy('energy-budget', 24.31)],
